    ...
    public partial class AbstractDraggableWindow_E
    {
        ...
        public virtual void SetWindowIcon(StyleKeys keys)
        {
            if (m_windowIcon == null)
                m_windowIcon = new View_E(QR("icon"), "UI/Style/Windows/Window_Icon", keys);
        ...
        public virtual void SetCloseButton()
        {
            if (m_closeButton == null)
                m_closeButton = new Button_E(QR<Button>("closeButton"), "VerticalRectangle", StyleKeys.DefaultBackgroundAndBorder);
    ...
    public partial class AbstractDraggableWindow_E : AbstractWindow_E
    {
        ...
        public override void SetTopBar(string name)
        {
            if (m_windowTopBar == null)
                m_windowTopBar = new Label_E(QR<Label>("windowName"), "Title", StyleKeys.Default);
            m_windowTopBar.UpdateRootManipulator(PopupManipulator());
            base.SetTopBar(name);
        }
    }
}
