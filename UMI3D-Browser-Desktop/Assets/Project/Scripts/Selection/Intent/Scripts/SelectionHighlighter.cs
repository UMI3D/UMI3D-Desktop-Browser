...
public class SelectionHighlighter : Singleton<SelectionHighlighter>
{
    /// <summary>
    ...
    public void ActivateSelectedHighlight(InteractableContainer interactable)
    {
    ...
    public void DeactivateSelectedHighlight(InteractableContainer interactable)
    {
        var renderer = interactable.gameObject.GetComponentInChildren<Renderer>();
        if (renderer != null && renderer.material != null)
        {
