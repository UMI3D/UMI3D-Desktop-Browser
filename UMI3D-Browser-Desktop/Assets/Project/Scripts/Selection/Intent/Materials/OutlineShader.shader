...
// Shrimpey's Ultimate Outline Shader - MIT Licence https://github.com/Shrimpey/UltimateOutline
...
Shader "Outlined/UltimateOutline"
{
	Properties
	{
		...
		_FirstOutlineColor("Outline color", Color) = (0,0,1,0.5)
		_FirstOutlineWidth("Outlines width", Range(0.0, 2.0)) = 0.15

		_SecondOutlineColor("Outline color", Color) = (0,0,0.5,1)
