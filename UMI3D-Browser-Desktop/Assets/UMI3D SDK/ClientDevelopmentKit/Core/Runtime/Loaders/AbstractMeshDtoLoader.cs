...
namespace umi3d.cdk
{
    ...
    public abstract class AbstractMeshDtoLoader : IResourcesLoader
    {
        ...
        public abstract void UrlToObject(string url, string extension, string authorization, Action<object> callback, Action<Umi3dExcption> failCallback, string pathIfObjectInBundle = "");
