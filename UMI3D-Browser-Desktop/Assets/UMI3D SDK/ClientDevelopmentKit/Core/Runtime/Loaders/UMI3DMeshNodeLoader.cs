...
namespace umi3d.cdk
{
    ...
    public class UMI3DMeshNodeLoader : AbstractRenderedNodeLoader
    {
        ...
        public override void ReadUMI3DExtension(UMI3DDto dto, GameObject node, Action finished, Action<Umi3dExcption> failed)
        {
                    ...
                    UMI3DResourcesManager.LoadFile(
                        ...
                        (o) =>
                        {
                            if (o is GameObject g && dto is UMI3DMeshNodeDto meshDto)
                            {
                                ...
                                failed?.Invoke(new Umi3dExcption(0, $"Cast not valid for {o.GetType()} into GameObject or {dto.GetType()} into UMI3DMeshNodeDto"));
