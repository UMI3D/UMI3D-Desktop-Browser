...
namespace umi3d.cdk
{
    ...
    public interface IResourcesLoader
    {
        ...
        void UrlToObject(string url, string extension, string authorization, Action<object> callback, Action<Umi3dExcption> failCallback, string pathIfObjectIsInBundle = "");
