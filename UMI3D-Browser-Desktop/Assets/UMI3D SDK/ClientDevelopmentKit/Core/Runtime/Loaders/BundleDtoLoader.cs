...
namespace umi3d.cdk
{
    ...
    public class BundleDtoLoader : IResourcesLoader
    {
        ...
        public virtual void UrlToObject(string url, string extension, string authorization, Action<object> callback, Action<Umi3dExcption> failCallback, string pathIfObjectInBundle = "")
        {
                ...
                () =>
                {
                    try
                    {
                        ...
                        if (bundle != null)
                            ...
                            failCallback.Invoke(new Umi3dExcption(0, "Bundle was empty"));
                    }
                    catch (Exception e)
                    {
                        failCallback.Invoke(new Umi3dExcption(0, e.Message));
                    }
                },
