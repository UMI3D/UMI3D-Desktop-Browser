...
namespace umi3d.cdk
{
    ...
    public class KHR_lights_punctualLoader
    {
        ...
        /// <param name="property">property containing the new value</param>
        /// <returns></returns>
        public virtual bool SetLightProperty(UMI3DEntityInstance entity, uint operationId, uint propertyKey, ByteContainer container)
        {
            KHR_lights_punctual dto = (entity.dto as GlTFNodeDto)?.extensions.KHR_lights_punctual;
            var node = entity as UMI3DNodeInstance;
        ...
        public virtual bool ReadLightProperty(ref object value, uint propertyKey, ByteContainer container)
        {
            if (propertyKey == UMI3DPropertyKeys.Light)
            {
