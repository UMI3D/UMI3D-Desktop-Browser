    ...
    public class UMI3DEnvironmentLoader : inetum.unityUtils.SingleBehaviour<UMI3DEnvironmentLoader>
    {
        ...
        public IEnumerator Load(GlTFEnvironmentDto dto, Action onSuccess, Action<string> onError)
        {
            ...
            while (!downloaded)
            {
                ...
                onProgressTitleChange.Invoke($"Load resources {loadedResources / resourcesToLoad *100}%");
                yield return null;
            }
            ...
            while (!loaded)
            {
                ...
                onProgressTitleChange.Invoke($"Instantiate environment {instantiatedNodes / nodesToInstantiate * 100}%");
                yield return null;
            }
