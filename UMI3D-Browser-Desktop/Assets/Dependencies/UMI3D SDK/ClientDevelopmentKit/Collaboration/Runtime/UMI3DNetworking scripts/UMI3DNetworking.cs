...
namespace umi3d.cdk.collaboration
{
    ...
    public static class UMI3DNetworking
    {
        ...
        {
            return LauncherOnWorldController.Connect(mediaDto, language, shouldCleanAbort, formReceived, formAnswerReceived, connectionStarted, connectionSucceeded, connectionFailed, maxTryCount, report);
        }
