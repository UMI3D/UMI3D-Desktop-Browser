...
public partial class ButtonMenuItem : umi3d.common.IObservable<bool>
{
    /// <summary>
    ...
    public virtual void NotifyValueChange(bool newValue)
    {
        ...
        foreach (Action<bool> sub in subscribers) sub.Invoke(m_isDown);
    }
    ...
    /// </summary>
    /// <param name="callback"></param>
    public virtual bool UnSubscribe(Action<bool> callback) => subscribers.Remove(callback);
}
