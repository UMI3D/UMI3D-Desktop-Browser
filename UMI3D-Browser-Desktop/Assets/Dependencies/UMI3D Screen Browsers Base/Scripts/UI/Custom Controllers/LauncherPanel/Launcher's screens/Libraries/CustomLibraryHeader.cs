...
public abstract class CustomLibraryHeader : CustomLibrary
{
    ...
    public override string USSCustomClassDelete_Icon => $"{USSCustomClassName}__header__search";
    public override string USSCustomClassDropDown_Button_Icon_Background => $"{USSCustomClassName}__header__drop-down__button__icon__background";
    public virtual string USSCustomClassHeader_NameSort_Icon => $"{USSCustomClassName}__header__name-sort__icon";
    public virtual string USSCustomClassHeader_SizeSort_Icon => $"{USSCustomClassName}__header__size-sort__icon";
    public virtual string USSCustomClassHeader_Sort_Icon_Asc => $"{USSCustomClassName}__header__sort__icon__ascending";
    public virtual string USSCustomClassHeader_Sort_Icon_Desc => $"{USSCustomClassName}__header__sort__icon__descending";
    public virtual string USSCustomClassHeader_Search_Field => $"{USSCustomClassName}__header__search__field";
    public virtual string USSCustomClassHeader_Filter_Field => $"{USSCustomClassName}__header__filter__field";
