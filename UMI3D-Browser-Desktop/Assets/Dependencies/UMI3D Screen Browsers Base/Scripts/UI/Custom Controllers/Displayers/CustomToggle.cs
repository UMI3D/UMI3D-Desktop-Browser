...
public abstract class CustomToggle : Toggle, ICustomElement
{
    ...
    public virtual string StyleSheetPath => $"{ElementExtensions.StyleSheetDisplayersFolderPath}/toggle";
    public virtual string USSCustomClassName => "toggle";
